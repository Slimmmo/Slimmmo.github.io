...
/*        if ($scope.selectAll[1]) {
  ...
  function loadDefaults() {
    ...
    $scope.carol.baseProfit = [0.06, 6172, 123.401e+6, 1.846265e+12, 2.41302e+16, ?, ?, ?, ?];
