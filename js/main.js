...
/*        if ($scope.selectAll[1]) {
  ...
  function loadDefaults() {
    ...
    /*$scope.carol.angelScale = 150;
    $scope.carol.baseCost = [];
    $scope.carol.basePower = [];
    $scope.carol.baseProfit = [];
    $scope.carol.baseSpeed = [];
  ...
  function loadUnlocks() {
    ...
    /*$scope.carol.unlocks[0] = [];
    $scope.carol.unlocks[1] = [];
    $scope.carol.unlocks[2] = [];
    $scope.carol.unlocks[3] = [];
    $scope.carol.unlocks[4] = [];
    $scope.carol.unlocks[5] = [];
    $scope.carol.unlocks[6] = [];
    $scope.carol.unlocks[7] = [];
    $scope.carol.unlocks[8] = [];
    $scope.carol.unlocks[9] = [];
    $scope.carol.cashUpgrades = [];
    $scope.carol.angelUpgrades = [];
