...
advApp.controller('advController', ['$document', '$filter', '$scope', function($document, $filter, $scope) {
  ...
  $scope.superbadgeList = [
    ...
    */
    ...
    ['Speaker', 1, [16, 15]],
    ['Boxing Bear', 2, [8, 20]],
    ['The Time Machine', 2, [14, 15]]
  ];
  var planets = ['earth', 'moon', 'mars', 'excellent'];
  ...
  $scope.isEvent = function() {
    return $scope.ref == $scope.excellent;
  };
...
/*        if ($scope.selectAll[1]) {
  ...
  function loadUnlocks() {
    ...
    // 0 -  Dino Shock Collars Profit
    // 1 -  Dino Shock Collars Speed
    // 2 -  Pyramid Cranes Profit
    // 3 -  Pyramid Cranes Speed
    // 4 -  7 Blade Viking Razors Profit
    // 5 -  7 Blade Viking Razors Speed
    // 6 -  Horse GPS Profit
    // 7 -  Horse GPS Speed
    // 8 -  Medieval Soap on a Rope Profit
    // 9 -  Medieval Soap on a Rope Speed
    // 10 - Camel AC Units Profit
    // 11 - Camel AC Units Speed
    // 12 - Sabretooth Litterboxes Profit
    // 13 - Sabretooth Litterboxes Speed
    // 14 - Bubonic Mouse Traps Profit
    // 15 - Bubonic Mouse Traps Speed
    // 16 - Pirate Ship Outboard Profit
    // 17 - Pirate Ship Outboard Speed
