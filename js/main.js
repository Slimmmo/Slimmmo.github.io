...
/*        if ($scope.selectAll[1]) {
  ...
  function loadUnlocks() {
    ...
    // 0 = Pumpkin Spice Infuser Profit
    // 1 = Pumpkin Spice Infuser Speed
    // 2 = Touch Screen Football Profit
    // 3 = Touch Screen Football Speed
    // 4 = Gravy-Go Helmet Profit
    // 5 = Gravy-Go Helmet Speed
    // 6 = Snug-xedo Profit
    // 7 = Snug-xedo Speed
    // 8 = Small Talk Decoy Profit
    // 9 = Small Talk Decoy Speed
    // 10 = Leftover Delivery Drones Profit
    // 11 = Leftover Delivery Drones Speed
    // 12 = Fi-doo 3000 Profit
    // 13 = Fi-doo 3000 Speed
    // 14 = Leaf Thrower Profit
    // 16 = Leaf Thrower Speed
    // 16 = Turkey Multi-Tool Profit
    // 17 = Turkey Multi-Tool Speed
    // 18 = All Profit
    // 19 = All Speed
    $scope.gizmo.unlocks[0] = [[100, [0, 20]]];
    $scope.gizmo.unlocks[1] = [[120, [2, 111]]];
    ...
    $scope.gizmo.unlocks[9] = [[1, [19, 2]], [2, [19, 2]]];
    $scope.gizmo.cashUpgrades = [];
    $scope.gizmo.angelUpgrades = [];
