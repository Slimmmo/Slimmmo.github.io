...
/*        if ($scope.selectAll[1]) {
  ...
  function loadUnlocks() {
    ...
    // 0 = Apple Bobbing Profit
    // 1 = Apple Bobbing Speed
    // 2 = Best Suit Contest Profit
    // 3 = Best Suit Contest Speed
    // 4 = Monster Mash DJ Profit
    // 5 = Monster Mash DJ Speed
    // 6 = Sewer Tours Profit
    // 7 = Sewer Tours Speed
    // 8 = Insufficient Fun House Profit
    // 9 = Insufficient Fun House Speed
    // 10 = Cereal Killer House Profit
    // 11 = Cereal Killer House Speed
    // 12 = Scairy Tale House Profit
    // 13 = Scairy Tale House Speed
    // 14 = Prankenstein House Profit
    // 16 = Prankenstein House Speed
    // 16 = Last Mansion on the Left Profit
    // 17 = Last Mansion on the Left Speed
    // 18 = All Profit
    // 19 = All Speed
    ...
    $scope.easystreet.unlocks[3] = [[20, [6, 13]], [80, [6, 13]], [160, [6, 26]], [320, [6, 12]], [500, [18, 2]], [750, [18, 2]], [950, [6, 7]]];
    ...
    $scope.easystreet.cashUpgrades = [[5e6, [0, 111], false], [170e6, [2, 111], false], [2e9, [4, 111], false], [40e9, [6, 111], false], [300e9, [8, 111], false], [2.2e12, [10, 111], false], [120e12, [12, 111], false], [4e15, [14, 111], false], [500e15, [16, 111], false], [250e21, [4, 111], false], [470e21, [6, 111], false], [1.5e24, [8, 111], false], [2.5e24, [10, 111], false], [12.5e24, [12, 111], false], [60e24, [14, 28], false], [100e24, [16, 2], false], [2e27, [2, 111], false], [5e27, [0, 3], false], [6e30, [16, 13], false], [60e30, [14, 3], false], [4e33, [6, 7], false], [8e36, [0, 20], false], [700e36, [6, 2], false], [2e39, [8, 77], false], [35e39, [2, 999], false], [40e42, [14, 10], false], [90e42, [12, 33], false], [230e42, [10, 999], false], [1.5e45, [8, 7], false], [6e45, [4, 999], false], [30e45, [6, 7], false], [140e45, [2, 99], false], [1.6e48, [0, 99], false], [50e48, [12, 99], false], [50e48, [14, 88], false], [50e48, [16, 2], false], [600e48, [6, 7], false], [600e48, [8, 2], false], [600e48, [10, 4], false], [40e51, [0, 22], false], [40e51, [2, 19], false], [40e51, [4, 7], false]];
    ...
    $scope.onepercent.unlocks[9] = [[1, [19, 4]],[16, [19, 3.5]],[20, [18, 7]],[25, [18, 7]],[32, [18, 7]],[44, [18, 2]],[53, [18, 7]],[62, [18, 9]],[67, [18, 9]],[72, [18, 9]],[77, [18, 9]]];
