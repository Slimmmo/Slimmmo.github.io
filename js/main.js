...
advApp.controller('advController', ['$document', '$filter', '$scope', function($document, $filter, $scope) {
  ...
  var planets = ['earth', 'moon', 'mars', 'liveprofits'];
  ...
  $scope.isEvent = function() {
    return $scope.ref == $scope.liveprofits;
  };
...
/*        if ($scope.selectAll[1]) {
  ...
  function loadDefaults() {
    ...
    $scope.liveprofits.angelScale = 45;
    $scope.liveprofits.baseCost = [];
    $scope.liveprofits.basePower = [];
    $scope.liveprofits.baseProfit = [];
    $scope.liveprofits.baseSpeed = [];
    $scope.liveprofits.hasMegaTickets = false;
    $scope.liveprofits.investments = [
    ];
  ...
  function loadUnlocks() {
    ...
    // 18 - 
    // 19 - 
    $scope.liveprofits.unlocks[0] = [];
    $scope.liveprofits.unlocks[1] = [];
    $scope.liveprofits.unlocks[2] = [];
    $scope.liveprofits.unlocks[3] = [];
    $scope.liveprofits.unlocks[4] = [];
    $scope.liveprofits.unlocks[5] = [];
    $scope.liveprofits.unlocks[6] = [];
    $scope.liveprofits.unlocks[7] = [];
    $scope.liveprofits.unlocks[8] = [];
    $scope.liveprofits.unlocks[9] = [];
    $scope.liveprofits.cashUpgrades = [];
    $scope.liveprofits.angelUpgrades = [];
    $scope.liveprofits.managerUpgrades = [];
