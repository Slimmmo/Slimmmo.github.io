...
/*        if ($scope.selectAll[1]) {
  ...
  function loadDefaults() {
    ...
    $scope.liverich.investments = [
      ...
      ['Cleaning Droid', 0, false, 0, 0, 0, 0],
      ['Spicy Sand Worm', 0, false, 0, 0, 0, 0],
      ['Red Shirt', 0, false, 0, 0, 0, 0],
      ['Barf Bucket', 0, false, 0, 0, 0, 0],
      ['Space Gate', 0, false, 0, 0, 0, 0],
      ['Calling Card', 0, false, 0, 0, 0, 0],
      ['Bug Spray', 0, false, 0, 0, 0, 0],
      ['Space Buddy', 0, false, 0, 0, 0, 0]
    ];
