...
advApp.controller('advController', ['$document', '$filter', '$scope', function($document, $filter, $scope) {
  ...
  $scope.moon = {};
  $scope.raw = false;
  $scope.ref = $scope.love;//$scope.earth;
  $scope.reverse = true;
...
/*        if ($scope.selectAll[1]) {
  ...
  function loadUnlocks() {
    ...
    $scope.love.unlocks[0] = [[250, [18, 3.33]],[1111, [18, 5.55]],[250, [2222, 7.77]]];
    ...
    $scope.love.cashUpgrades = [[12345, [0, 2], false],[67890, [2, 2], false],[123456, [4, 2], false],[789012, [6, 2], false],[1234567, [8, 2], false],[8901234, [10, 2], false],[12345678, [12, 2], false],[90123456, [14, 2], false],[123456789, [16, 2], false],[1.234e+9, [18, 2], false],[24.681e+9, [0, 5], false],[369.121e+9, [2, 5], false],[4.812e+12, [4, 5], false]];
