...
/*        if ($scope.selectAll[1]) {
  ...
  function loadDefaults() {
    ...
    $scope.liverich.angelScale = 150; // Figure out when event starts
    $scope.liverich.baseCost = [12, 200, 770, 2268, 46662, 65, 770, 3708, 31900, 8666658]; // Figure out when event starts
    $scope.liverich.basePower = [1.09, 1.18, 1.36, 1.72, 2.44, 1.03, 1.09, 1.27, 1.81, 3.43]; // Figure out when event starts
  ...
  function loadUnlocks() {
    ...
    $scope.liverich.unlocks[0] = [0, [0, 0]];
    $scope.liverich.unlocks[1] = [0, [0, 0]];
    $scope.liverich.unlocks[2] = [0, [0, 0]];
    $scope.liverich.unlocks[3] = [0, [0, 0]];
    $scope.liverich.unlocks[4] = [0, [0, 0]];
    $scope.liverich.unlocks[5] = [0, [0, 0]];
    $scope.liverich.unlocks[6] = [0, [0, 0]];
    $scope.liverich.unlocks[7] = [0, [0, 0]];
    $scope.liverich.unlocks[8] = [0, [0, 0]];
    $scope.liverich.unlocks[9] = [0, [0, 0]];
    $scope.liverich.unlocks[10] = [0, [0, 0]];
    $scope.liverich.cashUpgrades = [[0, [0, 0], false]];
    $scope.liverich.angelUpgrades = [[0, [0, 0], false, false]];
