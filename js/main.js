...
/*        if ($scope.selectAll[1]) {
  ...
  function loadDefaults() {
    ...
    $scope.lyp.basePower = [1.023, 1.045, 1.083, 1.166, 1, 1, 1, 1, 1];
    $scope.lyp.baseProfit = [0.5, 9, 81, 729, 1, 1, 1, 1, 1];
    $scope.lyp.baseSpeed = [1.5, 5, 8, 18, 1, 1, 1, 1, 1];
  ...
  function loadUnlocks() {
    ...
    // 0 - Belly Flopping Profit
    // 1 - Belly Flopping Speed
    // 2 - Larping Profit
    // 3 - Larping Speed
    // 4 - Rock, Paper, Scissors Profit
    // 5 - Rock, Paper, Scissors Speed
    // 6 - Bear Knuckle Boxing Profit
    // 7 - Bear Knuckle Boxing Speed
    // 8 - Backyard Wrestling Profit
    // 9 - Backyard Wrestling Speed
    // 10 - Running of the Bulls Profit
    // 11 - Running of the Bulls Speed
    // 12 - Competetive Eating Profit
    // 13 - Competetive Eating Speed
    // 14 - MXC Profit
    // 15 - MXC Speed
    // 16 - E-Sports Profit
    // 17 - E-Sports Speed
